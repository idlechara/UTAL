...
class LSM303DLHC {
    private:
        magdata_t accelerometer_calib_min, accelerometer_calib_max, magnetometer_calib_min, magnetometer_calib_max;
    ...
    public:
        ...
        int add_accelerometer_calibration_data();
        int add_magnetometer_calibration_data();
