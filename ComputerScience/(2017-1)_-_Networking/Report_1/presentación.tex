...
\author[F. Olivares, E. Regla]{Fabián Olivares, Erik Regla\\ \{folivares13,eregla09\}@alumnos.utalca.cl}                 % Enter your name between curly braces
...
\begin{frame}[c,fragile, shrink=20]
	\frametitle{Llaves foráneas y restricciones de integridad}
