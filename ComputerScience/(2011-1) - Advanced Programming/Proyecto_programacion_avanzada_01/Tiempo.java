...
public class Tiempo {
	 ...
	 * @throws ArrayStoreException si es que los tiempos son incompatibles, osea, no se puede reservar
	 * 
	 * @author Erik Andres Regla Torres
	 * @version 0.2
	 * @since 0.1
	...
	public void reservarDia(int semana, HashMap<Integer, ArrayList> diaBloque) throws ArrayStoreException{
			...
			if(diaBloque.containsKey(valor)){
				...
				for(Object obj: diaBloque.get(valor)){
					...
					if(!matrix[semana][i][valor.intValue()]){
						throw new ArrayStoreException("No es posible reservar, ya que los tiempos son incompatibles.");
					}
	 ...
	 */
	@SuppressWarnings("rawtypes")
	public void reservarSemestre(HashMap<Integer, ArrayList> diaBloque) throws ArrayStoreException{
