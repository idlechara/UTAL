 ...
 * @author ve´ronica
 */
public class PanelAvisoGeneral extends ReferencePanel 
{
    ...
    public PanelAvisoGeneral(String titulo,String nombreArchivo,File archivo, String observaciones) {
        super(ReferencePanel.TIPO1);
        this.createObjects();
        ...
        try
        {
            if(!this.isEmptyFields())
            {
                if(archivo.testFile())
                {
                    ...
                    Message m = new Message(0, com.message.Message.AVISO_PRE, dia, mes, año);
                    m.add("Título", this.titulo.getText());
                    m.add("Archivo Adjunto", this.archivo.getDirectoryNameArchivo());
