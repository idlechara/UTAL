...
import com.jogamp.opengl.impl.glu.mipmap.Image;
...
public class Imagen3D extends Imagen2D{
	...
	private int metricUnit = 0;
	
	Imagen2D imagenRenderizable = null;
	
	Color[][][] colores= null;
	float medidaPorVoxel = 0;
	...
	public void tamaño(float tamaño){
		...
		BufferedImage temp = new BufferedImage(this.width*(int)tamaño, this.height*(int)tamaño, this.getType());
