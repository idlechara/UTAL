...
//		 */
//
//		this.brazo.controlador.sis.printLog("cabeza: mover()");
//		direccion=0;
//		if(iniciado){
//			i=brazo.controlador.sis.puntoInicial.x;
//			iniciado = false;
//		}
//		
//		while((siguente)&&(zonas.coordEZ.contains(i, altura)== false)&&(zonas.coordZT.contains(i, altura))){
//			brazo.registraPunto(i,altura);
////			if(((zonas.coordEZ.contains(i+2, altura)== false)&&(zonas.coordZT.contains(i+2, altura)!= false)==false)&&
////					((zonas.coordEZ.contains(i-2, altura)== false)&&(zonas.coordZT.contains(i-2, altura)!= false)==false)&&
////					((zonas.coordEZ.contains(i, altura+2)== false)&&(zonas.coordZT.contains(i, altura+2)!= false)==false))
////				return true;
//			if(sentido){
//				siguente = (zonas.coordEZ.contains(i+2, altura+2)== false)&&(zonas.coordZT.contains(i+2, altura+2));
//			}
...
//			}
//		}
//		this.brazo.controlador.sis.showError("Aveces queda la kga");
//		return false;
	}
