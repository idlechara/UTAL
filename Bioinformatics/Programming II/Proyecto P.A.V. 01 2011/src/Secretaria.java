 ...
 * cambiar su encargado, añadir y quitar de su control 
 * proyectores y salas.
 * 
 ...
 * @since 0.1
 */
public class Secretaria <Proyector, Sala, Tiempo> {
	 ...
	 * clases diseñadas. Primero se verifica que existan proyectores disponibles,
	...
	public boolean reservarProyector(Tiempo tiempo){
		...
		for(Proyector proyector : this.listaProyectores){
			if(proyector.updateDisponibilidad(tiempo)){
				return true;
			}
		}
		return false;
