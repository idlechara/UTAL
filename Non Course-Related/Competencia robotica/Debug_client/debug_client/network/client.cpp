...
int Client::recieve_from_server(std::magdata_t *data) {
    //primero recibir la cantidad de datos y el tipo de datos
    static char type;
    static unsigned int size;
    static unsigned int recieved_bytes;

    recieved_bytes = recv(stream_descriptor, &size, sizeof(unsigned int), 0);
