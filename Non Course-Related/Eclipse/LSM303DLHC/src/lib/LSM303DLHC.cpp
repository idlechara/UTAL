...
//    cout << this->i2c_magnetometer_handler << " : mag" << endl;
    ...
    this->accelerometer_calib_max.x = -1.0;
    this->accelerometer_calib_max.y = -1.0;
    this->accelerometer_calib_max.z = -1.0;
    this->accelerometer_calib_min.x = 1.0;
    this->accelerometer_calib_min.x = 1.0;
    this->accelerometer_calib_min.x = 1.0;
    this->magnetometer_calib_max.x = -1.0;
    this->magnetometer_calib_max.y = -1.0;
    this->magnetometer_calib_max.z = -1.0;
    this->magnetometer_calib_min.x = 1.0;
    this->magnetometer_calib_min.x = 1.0;
    this->magnetometer_calib_min.x = 1.0;
}
